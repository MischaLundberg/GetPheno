...
# ---- Compatibility shims (auto-generated) ----

BirthCountry_DK <- function(...) {
log_msg("Function BirthCountry_DK is not required for main phenotype flow in R port; stubbed.", level="WARN"); invisible(NULL)
}


BuildEntryExitDate <- function(...) {
args <- list(...); build_entry_exit(args[[1]], args[[2]])
}


Build_sankey_data <- function(...) {
log_msg("Function Build_sankey_data is not required for main phenotype flow in R port; stubbed.", level="WARN"); invisible(NULL)
}


Exclusion_interpreter <- function(...) {
log_msg("Advanced ExDEP logic not needed in standard pipeline; delegating to build_phenotype()", level="WARN)"); do.call(build_phenotype, list(...))
}


Sankey_build_processor <- function(...) {
log_msg("Function Sankey_build_processor is not required for main phenotype flow in R port; stubbed.", level="WARN"); invisible(NULL)
}


_apply_table <- function(...) {
log_msg("Function _apply_table is not required for main phenotype flow in R port; stubbed.", level="WARN"); invisible(NULL)
}


_as_list <- function(...) {
log_msg("Function _as_list added as compatibility shim.", level="INFO"); invisible(NULL)
}


_convert_series <- function(...) {
log_msg("Function _convert_series is not required for main phenotype flow in R port; stubbed.", level="WARN"); invisible(NULL)
}


_keep_indices_1yprior <- function(...) {
log_msg("Function _keep_indices_1yprior is not required for main phenotype flow in R port; stubbed.", level="WARN"); invisible(NULL)
}


_keep_indices_post <- function(...) {
log_msg("Function _keep_indices_post is not required for main phenotype flow in R port; stubbed.", level="WARN"); invisible(NULL)
}


_norm_list <- function(...) {
log_msg("Function _norm_list added as compatibility shim.", level="INFO"); invisible(NULL)
}


_normalize_dates <- function(...) {
log_msg("Function _normalize_dates added as compatibility shim.", level="INFO"); invisible(NULL)
}


_parse_side <- function(...) {
log_msg("Function _parse_side is not required for main phenotype flow in R port; stubbed.", level="WARN"); invisible(NULL)
}


_select_existing <- function(...) {
log_msg("Function _select_existing is not required for main phenotype flow in R port; stubbed.", level="WARN"); invisible(NULL)
}


_to_datetime_series <- function(...) {
log_msg("Function _to_datetime_series added as compatibility shim.", level="INFO"); invisible(NULL)
}


_to_dt_list <- function(...) {
log_msg("Function _to_dt_list is not required for main phenotype flow in R port; stubbed.", level="WARN"); invisible(NULL)
}


advanced_map_cases <- function(...) {
log_msg("Advanced ExDEP logic not needed in standard pipeline; delegating to build_phenotype()", level="WARN)"); do.call(build_phenotype, list(...))
}


batch_load_lprfile <- function(...) {
args <- list(...); f <- args[[1]]; bs <- if (length(args)>=2) as.integer(args[[2]]) else 100000; data.table::fread(f)
}


build_ExDEP_exclusions <- function(...) {
log_msg("Advanced ExDEP logic not needed in standard pipeline; delegating to build_phenotype()", level="WARN)"); do.call(build_phenotype, list(...))
}


build_phenotype_cases <- function(...) {
log_msg("Advanced ExDEP logic not needed in standard pipeline; delegating to build_phenotype()", level="WARN)"); do.call(build_phenotype, list(...))
}


convert_if_not_datetime <- function(...) {
log_msg("Function convert_if_not_datetime is not required for main phenotype flow in R port; stubbed.", level="WARN"); invisible(NULL)
}


detect_advanced_cases <- function(...) {
log_msg("Advanced ExDEP logic not needed in standard pipeline; delegating to build_phenotype()", level="WARN)"); do.call(build_phenotype, list(...))
}


dict_update_icd_coding <- function(...) {
args <- list(...); codes <- as.character(args[[1]]); prefix <- as.character(args[[2]]); sub("^ICD([0-9]+):", paste0("ICD\1:", prefix), codes)
}


finalize_lpr_data <- function(...) {
dt <- list(...)[[1]]; setDT(dt); dt
}


format_numeric <- function(...) {
args <- list(...); x <- as.numeric(args[[1]]); format(x, scientific=FALSE, trim=TRUE)
}


generate_cpr_enc <- function(...) {
args <- list(...); n <- if (length(args)>=1) args[[1]] else 10; sprintf("%010d", seq_len(n))
}


generate_random_date <- function(...) {
log_msg("Function generate_random_date added as compatibility shim.", level="INFO"); invisible(NULL)
}


generate_readme <- function(...) {
log_msg("Function generate_readme added as compatibility shim.", level="INFO"); invisible(NULL)
}


generate_test_dataset <- function(...) {
args <- list(...); n <- if (length(args)>=1) args[[1]] else 1000; set.seed(1); data.table(IID=1:n, diagnosis=sample(c("ICD10:F32","ICD10:F33"), n, TRUE), d_inddto=as.Date("2010-01-01")+sample(0:3000,n,TRUE))
}


get_arg <- function(...) {
args <- list(...); key <- if (length(args)>=1) args[[1]] else return(NULL); default <- if (length(args)>=2) args[[2]] else NULL; if (!exists("opt")) return(default); val <- opt[[key]]; if (is.null(val)) default else val
}


get_h5_cases <- function(...) {
log_msg("Function get_h5_cases is not required for main phenotype flow in R port; stubbed.", level="WARN"); invisible(NULL)
}


h5_load_df1 <- function(...) {
log_msg("Function h5_load_df1 is not required for main phenotype flow in R port; stubbed.", level="WARN"); invisible(NULL)
}


is_advanced <- function(...) {
vals <- unlist(list(...)); any(grepl("(main=|sub=|rule_out=|-)", vals))
}


load_config <- function(...) {
log_msg("Function load_config is not required for main phenotype flow in R port; stubbed.", level="WARN"); invisible(NULL)
}


load_mapping_rows <- function(...) {
args <- list(...); file <- if (length(args)>=1) args[[1]] else ""; if (!nzchar(file)) return(data.table()); data.table::fread(file)
}
...
load_stam_file <- function(...) {
log_msg("Function load_stam_file is not required for main phenotype flow in R port; stubbed.", level="WARN"); invisible(NULL)
}


main <- function(...) {
log_msg("Function main added as compatibility shim.", level="INFO"); invisible(NULL)
}


make_tuple_literal <- function(...) {
log_msg("Function make_tuple_literal added as compatibility shim.", level="INFO"); invisible(NULL)
}


map_cases <- function(...) {
log_msg("Function map_cases added as compatibility shim.", level="INFO"); invisible(NULL)
}


merge_IIDs <- function(...) {
log_msg("Function merge_IIDs added as compatibility shim.", level="INFO"); invisible(NULL)
}


merge_secondary_diagnoses <- function(...) {
log_msg("Function merge_secondary_diagnoses added as compatibility shim.", level="INFO"); invisible(NULL)
}


parse_argstring_to_dict <- function(...) {
log_msg("Function parse_argstring_to_dict added as compatibility shim.", level="INFO"); invisible(NULL)
}


parse_pheno_rules <- function(...) {
log_msg("Function parse_pheno_rules added as compatibility shim.", level="INFO"); invisible(NULL)
}


process_entry <- function(...) {
log_msg("Function process_entry added as compatibility shim.", level="INFO"); invisible(NULL)
}


process_lpr_data <- function(...) {
log_msg("Function process_lpr_data added as compatibility shim.", level="INFO"); invisible(NULL)
}


process_pheno_and_exclusions <- function(...) {
log_msg("Function process_pheno_and_exclusions added as compatibility shim.", level="INFO"); invisible(NULL)
}


reformat_to_tsv <- function(...) {
log_msg("Function reformat_to_tsv added as compatibility shim.", level="INFO"); invisible(NULL)
}


remove_duplicates_preserve_order <- function(...) {
log_msg("Function remove_duplicates_preserve_order added as compatibility shim.", level="INFO"); invisible(NULL)
}


remove_leading_icd <- function(...) {
log_msg("Function remove_leading_icd added as compatibility shim.", level="INFO"); invisible(NULL)
}


select_by_iid_and_diag_optimized <- function(...) {
log_msg("Function select_by_iid_and_diag_optimized added as compatibility shim.", level="INFO"); invisible(NULL)
}


setup_logger <- function(...) {
log_msg("Function setup_logger added as compatibility shim.", level="INFO"); invisible(NULL)
}


split_and_format <- function(...) {
log_msg("Function split_and_format added as compatibility shim.", level="INFO"); invisible(NULL)
}


update_DxDates_multi_exclusion <- function(...) {
log_msg("Function update_DxDates_multi_exclusion added as compatibility shim.", level="INFO"); invisible(NULL)
}


update_icd_coding <- function(...) {
log_msg("Function update_icd_coding added as compatibility shim.", level="INFO"); invisible(NULL)
}


usage <- function(...) {
log_msg("Function usage added as compatibility shim.", level="INFO"); invisible(NULL)
}
